...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/portrait-enthusiastic-delighted-adult-dark-skinned-woman-with-curly-haircut_176420-31214.jpg",
          alt: "User",
        },
        {
      ...
      metrics={[
        {
          ...
          description: "High-intent leads delivered monthly",
          icon: CheckCircle,
        },
        {
          id: "m2",
          value: "4.2x",
          title: "Average ROI",
          description: "Turning ad spend into revenue",
          icon: TrendingUp,
        },
        {
          id: "m3",
          value: "98%",
          title: "Lead Quality",
          description: "Verified through multi-step vetting",
          icon: ShieldCheck,
        },
      ]}
      ...
      features={[
        {
          ...
          description: "Every lead is screened against your specific buyer persona criteria.",
        ...
        },
        {
          ...
          description: "Custom funnel architecture designed to minimize friction for your users.",
        ...
        },
        {
          ...
          description: "Seamless email and SMS drip campaigns keep leads warm until handover.",
          imageSrc: "http://img.b2bpic.net/free-photo/diet-healthy-eating-natural-food_53876-121381.jpg",
          buttonIcon: "Zap",
        },
        {
          title: "CRM Integration",
          description: "Direct syncing to your sales stack for real-time lead notification.",
          imageSrc: "http://img.b2bpic.net/free-photo/business-people-binary-code-sharing-technology-concept_53876-13712.jpg",
          buttonIcon: "Database",
        },
      ]}
  ...
  <div id="about" data-section="about">
      ...
      description={[
        "We are a team of data-obsessed marketers dedicated to the pay-per-lead model. We take on the risk so you can focus on building your product.",
        "Our philosophy is simple: if you don't grow, we don't succeed. That's why we obsess over quality control, channel diversity, and ROI at every single step.",
      ]}
    />
  </div>
      ...
      testimonials={[
        {
          ...
          name: "Jane Smith",
          handle: "@janesmith",
          testimonial: "LeadGenius changed everything. Our sales team went from hunting leads to just closing them.",
        ...
        },
        {
          ...
          name: "Mark Johnson",
          handle: "@markj",
          testimonial: "The lead quality is light years ahead of any other provider we have used.",
          imageSrc: "http://img.b2bpic.net/free-photo/skyscraper-view-city-leader-window-frame_1134-1034.jpg",
        },
        {
          id: "3",
          name: "Sarah Lee",
          handle: "@sarahlee",
          testimonial: "Finally, a partner that understands true ROI. We are hitting our targets consistently.",
        ...
        },
        {
          ...
          name: "David Brown",
          handle: "@dbrown",
          testimonial: "Exceptional communication and even better results. Highly recommended agency.",
        ...
        },
        {
          ...
          name: "Emma Wilson",
          handle: "@ewilson",
          testimonial: "Consistent, reliable, and scalable. Exactly what our startup needed.",
      ...
      plans={[
        {
          ...
          badge: "Entry",
          price: "$1,999/mo",
          subtitle: "Perfect for testing the funnel",
          features: [
            "50 Qualified Leads",
            "Dashboard Access",
            "Standard Support",
        ...
        },
        {
          ...
          badge: "Scale",
          price: "Custom",
          subtitle: "Volume for market dominance",
          features: [
            "500+ Qualified Leads",
            "Full Strategy Audit",
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "1",
          title: "How is lead quality determined?",
          content: "We use a multi-step verification process including phone validation and intent scoring.",
        },
        {
          id: "2",
          title: "Can I target specific regions?",
          content: "Absolutely. We build geo-fenced campaigns tailored to your service area.",
        },
        {
          id: "3",
          title: "Is there a long-term contract?",
          content: "We work on monthly cycles with no long-term commitment required.",
        },
      ]}
